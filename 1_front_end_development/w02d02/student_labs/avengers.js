...
console.log(ironMan.marvelMovieAppearances.spiderManHomecoming = true);
...
for (const i of instruments.guitar.electric) {
    console.log(i);
}
console.log(instruments.vocals = ['singer1', 'singer2', 'singer3']);
