...
:pencil2: [Writing Good User Stories](https://blogs.itemis.com/en/what-are-good-user-stories)
...
#### Playing a Two Player Game of Tic Tac Toe


 * As a player one,<br> I need to select a move,<br> in order for my marker (X) to be placed on the board

* As a player two,<br> I need to select a move,<br> in order for my marker (O) to be placed on the board


* Given a player makes a move<br>
 And the move results in three consecutive spaces with the same marker<br>
 The game is over and that player wins<br>

* Given a player makes a move<br>
 And the move is the last empty spot on the board  <br>
 and three consecutive spaces don't have the same marker<br>
 The game is over and it is a tie<br>
